...
## Search 1: Celery task decorator
...
The search was low confidence and returned mostly file-level summaries, not per-task detail. The Beat schedule file was the most valuable artifact from this search.

## Search 2: apply_async delay celery
