...
## Search 1: subscription order confirmation email (semantic)
...
## Search 2: recharge webhook charge paid order processed (semantic)
...
## Search 3: shopify order paid webhook email notification (exhaustive)
