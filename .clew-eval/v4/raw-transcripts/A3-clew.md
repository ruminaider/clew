...
Query: `clew search "pharmacy API call"`
...
Query: `clew search "refill order pharmacy"`
...
Query: `clew search "pharmacy error handling retry"` (intent detected as DEBUG → exhaustive mode)
...
Query: `clew search "WheelAPIClient prescription send"`
