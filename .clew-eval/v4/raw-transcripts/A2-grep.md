...
Searched for `checkout_source|checkout_sources|CheckoutSource|CHECKOUT_SOURCE` across the entire codebase. Found 50 files with matches, spanning backend models, migrations, services, views, serializers, admin, tests, scripts, and frontend TypeScript/JavaScript files.
