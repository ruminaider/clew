...
```bash
clew search "authentication decorator login_required permission_classes" --project-root /Users/albertgwo/Work/evvy --json --limit 20
```
Found key files:
...
```bash
clew search "IsAuthenticated AllowAny authentication_classes" --project-root /Users/albertgwo/Work/evvy --json --limit 20
```
Found:
...
```bash
clew search "APIView viewset API endpoint authentication" --project-root /Users/albertgwo/Work/evvy --json --limit 20
```
...
```bash
clew search "csrf_exempt AllowAny unauthenticated public" --project-root /Users/albertgwo/Work/evvy --json --limit 20
```
Found:
...
```bash
clew search "webhook_view csrf_exempt" --project-root /Users/albertgwo/Work/evvy --mode exhaustive --limit 15
```
...
```bash
clew search "class.*ViewSet class.*APIView permission_classes authentication_classes" --project-root /Users/albertgwo/Work/evvy --mode keyword --limit 30
```
...
### 13. Trace EvvyUserViewSet relationships
```bash
clew trace "EvvyUserViewSet" --project-root /Users/albertgwo/Work/evvy --json
```
...
```bash
clew search "throttle_classes" --project-root /Users/albertgwo/Work/evvy --mode keyword --limit 10
```
