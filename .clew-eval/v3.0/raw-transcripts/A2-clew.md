...
```bash
clew search "checkout source type" --project-root /Users/albertgwo/Work/evvy --json
clew search "CheckoutSource" --project-root /Users/albertgwo/Work/evvy --json
```
...
```bash
clew search "checkout source constants enum" --project-root /Users/albertgwo/Work/evvy --json
```
...
```bash
clew search "order.checkout_source =" --project-root /Users/albertgwo/Work/evvy --json
clew search "checkout_source serializer" --project-root /Users/albertgwo/Work/evvy --json
```
...
```bash
clew search "shopify app id constants" --project-root /Users/albertgwo/Work/evvy --json
```

### Call 11: Find App ID Constants with grep
```bash
grep -n "SHOPIFY.*APP_ID" backend/ecomm/constants.py
```
...
```bash
clew search "SHOPIFY_DISTRIBUTION_PARTNER_APP_ID SHOPIFY_RECHARGE" --project-root /Users/albertgwo/Work/evvy --json
...
```bash
clew search "checkout_source analytics braze segment" --project-root /Users/albertgwo/Work/evvy --json
clew search "admin checkout_source display" --project-root /Users/albertgwo/Work/evvy --json
```
