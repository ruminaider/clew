...
1. `Bash` - Changed to evvy directory
2. `Grep` - Found PrescriptionFill references (75 files)
3. `Grep` - Found subscription renewal references (2 files)
4. `Grep` - Found shopify webhook references (30 files)
...
7. `Grep` - Found `process_shopify_order` function definitions
8. `Read` - `/Users/albertgwo/Work/evvy/backend/ecomm/utils.py` (offset 204, limit 200)
9. `Grep` - Found PrescriptionFill.create patterns
...
13. `Grep` - Found `handle_charge_upcoming` function
