...
**Searches performed:**
- `search("class.*Email|def send_email")` in Python files
- `search("subscription.*complete|order.*complete|process.*order")` in Python files
...
4. search("Email class/send_email")
5. search("order processing")
6. Bash: Navigate to project directory
7. search("subscription order files")
8. search("email sending files")
9. read("subscriptions/service.py")
10. read("ecomm/tasks.py")
11. search("order confirmation")
12. read("webhooks.py")
13. search("process_shopify_order") (output too large)
