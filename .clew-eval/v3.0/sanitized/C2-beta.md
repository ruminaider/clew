# C2 Evaluation Transcript: Find all Stripe API calls
...
5. **Semantic search for "stripe.PaymentIntent"** - No Stripe results
...
10. **Find payment-related files** - Found payment/stripe/checkout files
...
- **Keyword search was more effective**: The keyword searches helped narrow down results
