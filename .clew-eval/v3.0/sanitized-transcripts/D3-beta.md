# Investigation: Subscription Order Email Failure Path (Beta)
...
**Searches performed:**
- `search("subscription.*order.*email|order.*confirmation.*email")`
- `search("send.*email.*subscription|email.*dispatch.*order")`
- `search("def send_confirmation_email|send_order_confirmation")`
...
**Searches performed:**
- `search("class.*Email|def send_email")`
- `search("subscription.*complete|order.*complete|process.*order")`
...
**Searches performed:**
- `search("subscription.*order|order.*subscription")` → Found 31 files
- `search("send.*email|email.*send")` → Found 79 files
...
**Searches performed:**
- `search("order.*confirmation|confirmation.*email")`
- `search("send.*email.*order|order.*email.*send|confirmation.*send")`
...
1. Search: subscription.*order.*email pattern search
2. Search: send.*email.*subscription pattern search
3. Search: send_confirmation_email function search
4. Search: Email class/send_email search
5. Search: order processing search
6. Navigate to project directory
7. Search: subscription order files search
8. Search: email sending files search
9. Read: subscriptions/service.py
10. Read: ecomm/tasks.py
11. Search: order confirmation search
12. Read: webhooks.py
13. Search: process_shopify_order search (output too large)
