...
After an exhaustive search of the codebase using both semantic search and direct text search across all Python, TypeScript, JavaScript, and configuration files, **the evvy codebase does not contain any direct Stripe API calls**.
