...
class SearchConfig(BaseModel):
    ...
    confidence_high_threshold_reranked: float = Field(default=0.65, ge=0.0, le=1.0)
    confidence_medium_threshold_reranked: float = Field(default=0.35, ge=0.0, le=1.0)
    confidence_high_threshold_rrf: float = Field(default=0.06, ge=0.0, le=1.0)
    confidence_medium_threshold_rrf: float = Field(default=0.02, ge=0.0, le=1.0)
